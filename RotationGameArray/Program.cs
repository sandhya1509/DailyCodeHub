...
using System.IO;
namespace RotationGameArray
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Hi Please enter the list you want to rotate");
          //  StreamReader sw = new StreamReader();
          //string s= sw.ReadLine();
          //  List<string> inputList = new List<string>() { s};

            int rotate = Convert.ToInt32(Console.ReadLine());

            //rotateArray(inputList,rotate);
        }

        #region Rotation game
        /*Rotation Game
        Problem Description
        ...
        #endregion
        public static void rotateArray(List<string> InpList,int rotate) 
         {
        // YOUR CODE GOES HERE
